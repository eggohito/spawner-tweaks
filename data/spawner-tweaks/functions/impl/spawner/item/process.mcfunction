...
execute if data storage spawner:tweaks temp.spawner.SpawnData unless data storage spawner:tweaks temp.spawner.SpawnPotentials[] run function spawner-tweaks:impl/spawner/item/process/spawn_potentials/append/spawn_data
